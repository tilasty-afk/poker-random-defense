...
export const UI = {
  ko: { hand:"운명의 손패", handHint:"7장 중 가장 강한 조합이 자동 선택됩니다", inventory:"병영", emptyInventory:"배치 대기 유닛", summonNext:"소환 예정", currentHand:"현재 족보", attack:"공격", range:"사거리", speed:"공속", recruit:"족보 확정 & 소환", selectedReroll:"선택 카드 교체", fullReroll:"전체 손패 교체", start:"웨이브 시작", pause:"일시 정지", keep:"유지", best:"최선", change:"교체", use:"사용", sell:"판매", recall:"병영으로 회수", placeHint:"빈 칸을 눌러 배치", attackUp:"공격 강화", speedUp:"속도 강화", totalAttack:"전체 공격력", totalSpeed:"전체 공격속도", guide:"족보별 소환 직업", open:"펼쳐 보기", tutorialAgain:"처음 설명 다시 보기", skip:"건너뛰기", next:"다음", begin:"게임 시작", gameOver:"성채 함락", retry:"다시 방어하기", endingReplay:"다시 플레이하기", bossEquivalent:"강적 1체 · 웨이브별 고유 체력", defeated:"명의 약탈자를 처치했습니다.", victory:"성채 방어 성공", clear:"200 웨이브 클리어", pausedRecruit:"일시정지 중에도 리롤·소환·배치 가능", language:"언어 변경", playback:"재생 속도 변경", demonArrival:"대마왕 등장!" },
  en: { hand:"Hand of Fate", handHint:"The strongest 5-card hand out of 7 is selected automatically", inventory:"Barracks", emptyInventory:"Units awaiting deployment", summonNext:"Next Summon", currentHand:"Current Hand", attack:"ATK", range:"Range", speed:"ASPD", recruit:"Confirm Hand & Summon", selectedReroll:"Reroll Selected", fullReroll:"Reroll All", start:"Start Wave", pause:"Pause", keep:"KEEP", best:"BEST", change:"CHANGE", use:"USE", sell:"Sell", recall:"Return to Barracks", placeHint:"Tap an empty tile to deploy", attackUp:"Upgrade ATK", speedUp:"Upgrade ASPD", totalAttack:"Global Attack", totalSpeed:"Global Attack Speed", guide:"Poker Hands & Units", open:"Open", tutorialAgain:"Replay Tutorial", skip:"Skip", next:"Next", begin:"Start Game", gameOver:"Fortress Fallen", retry:"Defend Again", endingReplay:"Play Again", bossEquivalent:"1 BOSS · UNIQUE HP BY WAVE", defeated:" raiders defeated.", victory:"Fortress Defended", clear:"200 WAVES CLEARED", pausedRecruit:"Reroll, summon, and deploy while paused", language:"Change language", playback:"Change game speed", demonArrival:"THE DEMON KING APPEARS!" },
  zh: { hand:"命运手牌", handHint:"自动选择7张牌中最强的5张组合", inventory:"兵营", emptyInventory:"待部署单位", summonNext:"即将召唤", currentHand:"当前牌型", attack:"攻击", range:"射程", speed:"攻速", recruit:"确认牌型并召唤", selectedReroll:"重抽所选牌", fullReroll:"重抽全部", start:"开始波次", pause:"暂停", keep:"保留", best:"最佳", change:"替换", use:"使用", sell:"出售", recall:"收回兵营", placeHint:"点击空位进行部署", attackUp:"强化攻击", speedUp:"强化攻速", totalAttack:"全军攻击力", totalSpeed:"全军攻击速度", guide:"牌型与召唤职业", open:"展开", tutorialAgain:"重看教程", skip:"跳过", next:"下一步", begin:"开始游戏", gameOver:"要塞陷落", retry:"再次防守", endingReplay:"再玩一次", bossEquivalent:"1名首领 · 每个波次独立生命值", defeated:"名掠夺者已被消灭。", victory:"要塞防守成功", clear:"通关200波", pausedRecruit:"暂停时仍可重抽、召唤和部署", language:"切换语言", playback:"切换游戏速度", demonArrival:"大魔王降临！" },
  ja: { hand:"運命の手札", handHint:"7枚から最も強い5枚の役を自動選択します", inventory:"兵舎", emptyInventory:"配置待機ユニット", summonNext:"召喚予定", currentHand:"現在の役", attack:"攻撃", range:"射程", speed:"攻速", recruit:"役を確定して召喚", selectedReroll:"選択カードを引き直す", fullReroll:"すべて引き直す", start:"ウェーブ開始", pause:"一時停止", keep:"維持", best:"最善", change:"交換", use:"使用", sell:"売却", recall:"兵舎へ戻す", placeHint:"空きマスをタップして配置", attackUp:"攻撃強化", speedUp:"攻速強化", totalAttack:"全体攻撃力", totalSpeed:"全体攻撃速度", guide:"役別の召喚職業", open:"開く", tutorialAgain:"チュートリアルを再表示", skip:"スキップ", next:"次へ", begin:"ゲーム開始", gameOver:"城塞陥落", retry:"もう一度防衛", endingReplay:"もう一度プレイ", bossEquivalent:"ボス1体・ウェーブ別固有HP", defeated:"体の略奪者を倒しました。", victory:"城塞防衛成功", clear:"200ウェーブクリア", pausedRecruit:"一時停止中も引き直し・召喚・配置可能", language:"言語変更", playback:"ゲーム速度変更", demonArrival:"大魔王、出現！" },
} as const;
...
export const TUTORIALS: Record<Locale, Array<{title:string;body:string}>> = {
  ko:[
    ...
    {title:"5. 성녀의 선택",body:"성녀 5기를 병영에 모으는 선택에도 의미가 있습니다. 즉시 사용과 보관을 전략적으로 판단하세요."},
  ],
  en:[
...
export function roleCopy(locale: Locale, category: string, tier: number) {
  ...
  const values: Record<string, [number[], string, string, string]> = {
    high:[[],"+1G on kill · +33% ATK per other Conscript","击杀敌人时额外获得1G · 每名其他征召兵使攻击力提高33%","敵撃破時に1G追加 · 他の徴集兵1体につき攻撃力33%増加"], pair:[[],"Leaves a mark that increases damage taken by 100% for 2 seconds","留下持续2秒、使受到伤害提高100%的标记","2秒間、受けるダメージが100%増加する標的を付与"],
    ...
    fourKind:[[],"+100% boss damage · 3-cell range","对Boss额外伤害100% · 射程3格","ボス追加ダメージ100% · 射程3マス"],
    straightFlush:[[],"Extremely powerful single-target damage · 5-cell range","极强的单体伤害 · 射程5格","非常に強力な単体ダメージ · 射程5マス"], royalFlush:[[],"Global damage over time","全场持续伤害","全域持続ダメージ"],
    fiveKind:[[],"Removes every enemy when deployed","部署时消灭所有敌人","配置時にすべての敵を消滅"], sixKind:[[],"Instantly grants 5,000G","立即获得5,000G","即座に5,000G獲得"], sevenKind:[[],"???","???","???"],
  };
  if (locale === "ko") return "";
