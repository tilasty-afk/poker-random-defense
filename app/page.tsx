...
const BALANCE = { baseHp: 100, hpScale: 2.2, hpPerWave: .04, hpGrowth: 1.028, baseSpeed: .76, speedPerWave: .003, maxSpeed: 1.55, damageScale: .24, bossHpUnits: 80, bossMoveScale: .58, spawnInterval: 432, minSpawnInterval: 312 } as const;
...
export default function Home() {
    ...
    const waveTarget = wave % 10 === 0 ? 1 : 36, isBossWave = wave % 10 === 0, monsterKind = monsterKindForWave(isBossWave ? Math.max(1, wave - 1) : wave), monsterBase = MONSTERS[monsterKind];
