...
const BALANCE = { baseHp: 100, hpScale: 3, hpPerWave: .04, hpGrowth: 1.028, baseSpeed: .76, speedPerWave: .003, maxSpeed: 1.55, damageScale: .24, bossHpUnits: 80, bossMoveScale: .58, spawnInterval: 432, minSpawnInterval: 312 } as const;
...
export default function Home() {
    ...
    function redraw() { if (cooldown > 0)
        return; if (selectedRerollsLeft <= 0) {
        setMessage("선택 카드 교체 횟수를 모두 사용했습니다. 전체 손패 교체로 충전하세요.");
        return;
    } if (!selected.length) {
